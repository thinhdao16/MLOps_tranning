...
def storm():
    ...
    for city_name in cities:
        ...
        formatted_prediction = {
            "storm_probability": "Có" if prediction["storm_probability"] == 1 else "Không",
        }
    ...
    if request.method == 'POST':
        ...
        user_data = {
            ...
            "wind": wind,
            "clouds": clouds,
            "storm_probability": "Có" if user_prediction["storm_probability"] == 1 else "Không",
        }
        user_data_list.append(user_data)

    return render_template('storm.html', weather_data_list=weather_data_list, user_data_list=user_data_list)