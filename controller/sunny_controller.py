...
def sunny():
    ...
    for city_name in cities:
        ...
        formatted_prediction = {
            "sunny_probability": "Có" if prediction["rain_probability"] == 1 else "Không",
        }
    ...
    if request.method == 'POST':
        ...
        user_data = {
            ...
            "wind": wind,
            "clouds": clouds,
            "sunny_probability": "Có" if user_prediction["rain_probability"] == 1 else "Không",
        }
        user_data_list.append(user_data)

    return render_template('sunny.html', weather_data_list=weather_data_list, user_data_list=user_data_list)